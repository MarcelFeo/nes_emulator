...
olc6502::olc6502()
{
    ...
    // https://www.masswerk.at/6502/6502_instruction_set.html ou https://github.com/iyakushev/NES.Athlon/issues/1
    using a = olc6502;
	lookup =
	{
...
// Retorna o valor de um Bit específico do status register
uint8_t olc6502::GetFlag(FLAGS6502 f)
{
	return ((status & f) > 0) ? 1 : 0;
}

// Sets ou Limpa a um Bit específico do status register
